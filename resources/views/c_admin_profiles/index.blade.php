   ...
   <h4>College ADMIN Dashboard</h4>
    <div class="row mt-5">
                ...
                <div class="col-2">
                   ...
                   <a href="/c_admin_profile/{{ $c_admin->id }}/edit"
                            >Edit Profile</a
                        >
                      @endcan @endauth
                </div>
                ...
                <div class="col-2  ">
                   @auth('c_admin') @can('update',
                        ...
                        <a href="/c_admin_profile/{{ $c_admin->id }}/events"
                            >add event</a
                        >
                ...
                @if(($c_admin->c_admin_profile->rejected ===1) && (auth()->user()->c_admin_profile==$c_admin->c_admin_profile))
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div
                                        class="alert alert-warning font-weight-light"
                                    >
                  ...
                  @elseif($c_admin->c_admin_profile->verified !==1)
                    ...
                    @auth('d_admin')
                    <form
                        action="{{route('c_admin_profile.verify',['d_admin'=>auth()->user()->id,'c_admin'=>$c_admin->id,])}}"
                        method="post"
                    >
                        @csrf @method('PATCH')
