    ...
    <div class="row">
        ...
        <div class="col-10 offset-1">
            ...
            <div class="col-9 offset-1">
                ...
                <div class="modal fade" id="event_{{$event->id}}" tabindex="-1" role="dialog" aria-labelledby="event"
                    aria-hidden="true">
        ...
        <div class="col-2">
            ...
            <div class="modal fadein" id="Addnewevent" tabindex="-1" role="form" aria-labelledby="event"
                aria-hidden="true">
